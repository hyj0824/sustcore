...
#define SYS_VFS_OPENDIR (SYSCALL_BASE + 0x1F)
#define SYS_VFS_OPEN    (SYSCALL_BASE + 0x20)
#define SYS_VFS_READ    (SYSCALL_BASE + 0x21)
#define SYS_VFS_WRITE   (SYSCALL_BASE + 0x22)
#define SYS_VFS_SIZE    (SYSCALL_BASE + 0x23)
#define SYS_VFS_SYNC    (SYSCALL_BASE + 0x24)
#define SYS_VFS_MKFILE  (SYSCALL_BASE + 0x25)
#define SYS_VFS_MKDIR   (SYSCALL_BASE + 0x26)
#define SYS_VFS_GETDENTS (SYSCALL_BASE + 0x27)
#define SYS_VFS_UNLINK   (SYSCALL_BASE + 0x28)
